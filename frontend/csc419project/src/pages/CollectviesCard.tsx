...
export default function ExploreCollectives() {
  ...
  <button
    ...
    className="bg-[#FF5C00] text-white font-bold py-2.5 px-4 md:px-5 rounded-xl hover:bg-orange-600 transition-all text-sm shadow-lg shadow-orange-500/10 whitespace-nowrap"
  >
    Create Collective
  </button>
</div>
          ...
          {collectives.map((collective) => (
            ...
            >
              <div className="h-24 w-full bg-zinc-800 relative">
                <img
                  src={collective.banner_url || "/head.png"}
              ...
              <div className="px-5 pb-6">
                <div className="relative -mt-8 flex justify-between items-end mb-4">
                  <img
                    src={collective.avatar_url || "/statue.png"}
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-gray-500">
                    {collective.handle || `@group-${collective.id}`}
                  </p>
                </div>
